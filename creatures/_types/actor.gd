...
var gait: int = 1                 # 0=sneak,1=walk,2=jog,3=sprint
var sprint_gate: float = 20.0     # winded gate; not enforced yet
...
# Physical properties (compiled) ───────────────────────────────────────────────
var mass_kg: float = 0.0   # set by SpeciesDB.apply_to()
